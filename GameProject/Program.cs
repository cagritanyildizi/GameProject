        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (choice == 1)
                {
                    ...
                    playerManager.Add(newPlayer: new NewPlayer() { TcNo = TcNo, PlayerName = PlayerName, PlayerSurname = PlayerSurname, BirthYear = BirthYear, UndertakingYear = UndertakingYear });
                }
